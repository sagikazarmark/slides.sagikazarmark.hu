...
date: "2025-06-19 18:30"
event: "Cloud Native Timişoara"
eventUrl: https://community.cncf.io/events/details/cncf-timisoara-romania-presents-cloud-native-timisoara-summer-2025/
description: |
    ...
    Dagger is a portable, programmable CI/CD engine that runs your pipelines in containers. In this session, we'll explore how Dagger can:
    ...
    By the end of this session, you'll be equipped to leverage Dagger to standardize environments, accelerate your CI/CD pipelines, and improve team collaboration.
...
_Let's see some code already!!!_

## Demo repository

[https://github.com/sagikazarmark/demo-cloud-native-timisoara-2025](https://github.com/sagikazarmark/demo-cloud-native-timisoara-2025)
