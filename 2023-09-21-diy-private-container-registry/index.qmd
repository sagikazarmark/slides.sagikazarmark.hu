...
::: {.notes}
- HTTP interface -> Basic auth
- Client support
:::

## Docker token auth "specification"
...
- Implements the token auth spec
- Maintenance policy is non-trivial
...
- Token auth is currently [broken](https://github.com/project-zot/zot/issues/1125)
...
- Registry auth [library](https://github.com/sagikazarmark/registry-auth) and [service](https://github.com/sagikazarmark/registry-auth-service)
- Build your own with the _library_
- Use an existing integration with the _service_
- ⚠️ **Work in progress!**

[https://github.com/sagikazarmark/registry-auth](https://github.com/sagikazarmark/registry-auth)

[https://github.com/sagikazarmark/registry-auth-service](https://github.com/sagikazarmark/registry-auth-service)

# Demo {background-color="#1b2975"}
